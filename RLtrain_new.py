...
model = SAC(
    ...
    buffer_size=200000,
    learning_starts=0,
    target_update_interval=20, #10
    #tau=0.05,
    gamma=0.99, #0.99
    policy_kwargs={"net_arch" : [128, 128]},
    verbose=1,
    tensorboard_log="./tensorboard/NOC_SAC_5/"
)
'''
model=A2C("MlpPolicy",
          env=env,
...
"""
model.learn(total_timesteps=32000, log_interval=3, progress_bar=True)
model.save("NoC_SAC_2")
env.render()
