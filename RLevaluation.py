...
class NoCEnv(gym.Env):
    ...
    def step(self,action):
        ...
        terminated=False
        truncated=bool(self.next_cycle==49800)# 不确定 每个episode的结束条件
...
#if self.count_144 == 0:
 #   reward=self.rewardRef[self.count]-self.rewardData[self.count]
#else:
 #   reward=self.rewardData[self.count-144]-self.rewardData[self.count]
